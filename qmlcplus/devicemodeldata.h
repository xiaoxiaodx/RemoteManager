...
public:
    explicit DeviceModelData(const bool &isSelect,const QString &deviceId,const QString &deviceName,QString deviceChannel,QString recordSavePath,int netState,bool isLogin = false,QObject *parent=nullptr):
